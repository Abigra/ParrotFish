...
#change legend so that false=macroalgae stable state and true=coral stab
#fix this one so that it relables the true and false in the legend 
...
##grazing values from single species model
```{r}
...
save(simulated_g_data_SSM, file="model_g_trajectories_SSM.Rdata")
#subsetting the data in order to look at the proportions of points which yeild a stable coral state
...
save(proportions_df_SSM, file="simulated_data_proportions_SSM.Rdata")
...
save(simulated_g_data, proportions_df, Resilience_Frame, proportions_df_SSM, simulated_g_data_SSM,  file="Combined_Model_simulated_data.Rdata")
```
